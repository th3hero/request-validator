...
describe('RequestValidator', () => {
  ...
  describe('validateInput', () => {
    ...
    it('should validate date format', async () => {
      ...
      expect(result.errors).toHaveProperty(
        'birthdate',
        'birthdate must be a valid date with format YYYY-MM-DD'
      );
    });
    ...
    it('should validate required_if condition', async () => {
      ...
      expect(result.errors).toHaveProperty(
        'business_name',
        'business_name is required when type is business'
      );
    });
    ...
    it('should handle file cleanup on validation error', async () => {
      ...
      expect(fs.unlink as unknown as jest.Mock).toHaveBeenCalledWith(
        '/tmp/test.pdf',
        expect.any(Function)
      );
    });
    ...
    it('should handle file validation with mixed mimetypes', async () => {
      ...
      expect(result.errors).toHaveProperty(
        'documents',
        'Invalid file format for documents. Supported media types are application/pdf'
      );
    });
  });
});
